...
exec .venv/bin/python experiments/rl/train_rl_sampling_prior.py \
  ...
  --output-dir results/research_platform/rl/path_conditioned_l185_seed20261903_60k \
  --seed 20261903 \
  > results/research_platform/rl/path_conditioned_l185_seed20261903_60k/console.log \
  2>&1
